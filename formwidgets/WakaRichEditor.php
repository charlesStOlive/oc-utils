...
{
    use \Waka\Utils\Classes\Traits\UploadableWidget;
    ...
    public function prepareVars()
    {
        ...
        $this->vars['allowAttributes'] = Config::get('waka.utils::froala.html_allow_attributes');
        $this->vars['noWrapTags'] = Config::get('waka.utils::froala.html_no_wrap_tags');
        $this->vars['removeTags'] = Config::get('waka.utils::froala.html_remove_tags');
        $this->vars['lineBreakerTags'] = Config::get('waka.utils::froala.html_line_breaker_tags');

        $this->vars['imageStyles'] = Config::get('waka.utils::froala.html_style_image');
        $this->vars['linkStyles'] = Config::get('waka.utils::froala.html_style_link');
        $this->vars['paragraphStyles'] = Config::get('waka.utils::froala.html_style_paragraph');
        $this->vars['paragraphFormats'] = Config::get('waka.utils::froala.html_paragraph_formats');
        $this->vars['tableStyles'] = Config::get('waka.utils::froala.html_style_table');
        $this->vars['tableCellStyles'] = Config::get('waka.utils::froala.html_style_table_cell');
    }
