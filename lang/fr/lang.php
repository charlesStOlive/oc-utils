...
return [
    ...
    "global" => [
        ...
        "duplicate_the" => "Dupliquer le",
        "duplicate_theDocument" => "Dupliquer le",
        "duplicate_theExport" => "Dupliquer l'export",
        "duplicate_theImport" => "Dupliquer l'import",
        "duplicate_theWakaMail" => "Dupliquer le Mail",
        "duplicate_theWakaPdf" => "Dupliquer le Pdf",
    ...
    "workflow" => [
        ...
        "confirm_no_trans_title" => "Pas de transition",
